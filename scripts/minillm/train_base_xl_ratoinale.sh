...
TEACHER_CKPT="${BASE_PATH}/results/rationale/train/sft/gpt2-xlarge/"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/rationale/prompt/gpt2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/rationale/full/gpt2/"
# runtime
SAVE_PATH="${BASE_PATH}/results/rationale/train/minillm/"
# hp
GRAD_ACC=1
BATCH_SIZE=16
CHUNK_SIZE=16
